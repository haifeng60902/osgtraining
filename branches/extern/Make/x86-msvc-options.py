...
if env.environ.has_key('DXSDK_DIR'):
	...
	LIBPATH_COMMON.append(os.path.join(env.environ['DXSDK_DIR'], 'Lib'))
...
CPPDEFINES_COMMON = ['WIN32', '_WIN32', '_WINDOWS', '_USE_MATH_DEFINES', 'NOMINMAX', '_CRT_SECURE_NO_DEPRECATE','_USING_V110_SDK71_'
]

# XP support on 2012
if env['MSVC_VERSION'] == "11.0":
	CPPDEFINES_COMMON += ['_USING_V110_SDK71_', '__WIN32_WINNT=0x0501', 'WINVER=0x0501']
	CPPPATH_COMMON = ['C:/Program Files/Microsoft SDKs/Windows/v7.1/Include'] + CPPPATH_COMMON
	LIBPATH_COMMON = ['C:/Program Files/Microsoft SDKs/Windows/v7.1/Lib'] + LIBPATH_COMMON
...
LINKFLAGS_COMMON = [
	...
	'/STACK:16777216', '/MACHINE:X86', '/MANIFEST',
]
