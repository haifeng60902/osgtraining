...
CPPDEFINES_COMMON = ['WIN64','_WINDOWS','WIN32_LEAN_AND_MEAN','WIN64_LEAN_AND_MEAN','_USE_MATH_DEFINES','NOMINMAX', 'EDGE', '_CRT_SECURE_NO_DEPRECATE']
...
LINKFLAGS_COMMON = ['-STACK:16777216', '/MACHINE:X64', '/MANIFEST', '/LARGEADDRESSAWARE']
