#ifndef _DYNAMIC_GROUP_LEVEL_2048_NODE_H_
#define _DYNAMIC_GROUP_LEVEL_2048_NODE_H_
...
class DynamicGroupLevel2048Node : public osg::Referenced
{
public:

	DynamicGroupLevel2048Node();
...
#endif	//_DYNAMIC_GROUP_LEVEL_2048_NODE_H_