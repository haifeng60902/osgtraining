#ifndef _GEOMETRY_TEXTURE_PATCH_1_H_
#define _GEOMETRY_TEXTURE_PATCH_1_H_
...
class GeometryTexturePatch1
{
public:
	//x,y - смещение €чейки, sizeC - количество сегментов, scaleC - размер €чейки
	GeometryTexturePatch1( int x , int y , int sizeC , int scaleC , osg::ref_ptr<osg::Image> image , double fAdd , double dScale );

	~GeometryTexturePatch1();
...
#endif	//_GEOMETRY_TEXTURE_PATCH_1_H_