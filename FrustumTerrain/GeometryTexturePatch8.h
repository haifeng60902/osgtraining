#ifndef _GEOMETRY_TEXTURE_PATCH_8_H_
#define _GEOMETRY_TEXTURE_PATCH_8_H_
...
class GeometryTexturePatch8
{
public:
	//x,y - смещение €чейки, sizeC - количество сегментов, scaleC - размер €чейки
	GeometryTexturePatch8( int x , int y , int sizeC , int scaleC , osg::ref_ptr<osg::Image> image , double fAdd , double dScale );

	~GeometryTexturePatch8();
...
#endif	//_GEOMETRY_TEXTURE_PATCH_8_H_